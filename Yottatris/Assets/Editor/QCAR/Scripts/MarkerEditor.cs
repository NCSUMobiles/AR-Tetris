...
public class MarkerEditor : Editor
{
    ...
    public void OnEnable()
    {
        ...
        if (!markerBehaviour.mInitializedInEditor)
        {
            ...
            ConfigData.FrameMarker fmConfig =
                SceneManager.Instance.GetFrameMarker(markerBehaviour.MarkerID);
    ...
    public override void OnInspectorGUI()
    {
        ...
        else
        {
            ...
            {
                ConfigData.FrameMarker fmConfig = new ConfigData.FrameMarker();

                fmConfig = SceneManager.Instance.GetFrameMarker(newMarkerID);
